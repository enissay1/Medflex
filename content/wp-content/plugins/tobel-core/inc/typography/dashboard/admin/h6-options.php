...
if ( ! function_exists( 'tobel_core_add_h6_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function tobel_core_add_h6_typography_options( $page ) {
		...
		if ( $page ) {
			$h6_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h6',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H6 Typography', 'tobel-core' ),
					'description' => esc_html__( 'Set values for Heading 6 HTML element', 'tobel-core' ),
				)
			);
	...
	add_action( 'tobel_core_action_after_typography_options_map', 'tobel_core_add_h6_typography_options' );
}
