...
if ( ! function_exists( 'tobel_core_add_h4_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function tobel_core_add_h4_typography_options( $page ) {
		...
		if ( $page ) {
			$h4_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h4',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H4 Typography', 'tobel-core' ),
					'description' => esc_html__( 'Set values for Heading 4 HTML element', 'tobel-core' ),
				)
			);
			...
			$h4_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Font Family', 'tobel-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$h4_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Font Size', 'tobel-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$h4_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Line Height', 'tobel-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$h4_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Letter Spacing', 'tobel-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$h4_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Text Transform', 'tobel-core' ),
					'options'    => tobel_core_get_select_type_options_pool( 'text_transform' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$h4_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Link Hover Color', 'tobel-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$h4_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Link Hover Text Decoration', 'tobel-core' ),
					'options'    => tobel_core_get_select_type_options_pool( 'text_decoration' ),
					'args'       => array(
						'col_width' => 3,
					),
			...
			$h4_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Margin Top', 'tobel-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$h4_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Margin Bottom', 'tobel-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$h4_1366_typography_section = $h4_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Responsive 1366 Typography', 'tobel-core' ),
				)
			);
			...
			$h4_1024_typography_section = $h4_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Responsive 1024 Typography', 'tobel-core' ),
				)
			);
			...
			$h4_768_typography_section = $h4_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Responsive 768 Typography', 'tobel-core' ),
				)
			);
			...
			$h4_680_typography_section = $h4_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Responsive 680 Typography', 'tobel-core' ),
				)
			);
	...
	add_action( 'tobel_core_action_after_typography_options_map', 'tobel_core_add_h4_typography_options' );
}
